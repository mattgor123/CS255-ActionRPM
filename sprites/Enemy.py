...
class Keg(game.sprite.Sprite):
    ...
    def __init__(self, location, screensize,
        ...
        if Keg.image is None:
            ...
            Keg.down = game.transform.rotate(Keg.right, -90)
            Keg.upright = game.transform.rotate(Keg.right, 45)
            Keg.upleft = game.transform.rotate(Keg.right, 135)
            Keg.downright = game.transform.rotate(Keg.right, -45)
            Keg.downleft = game.transform.rotate(Keg.right, -135)

        self.direction = direction
        self.set_direction(direction)
        self.image = Keg.image
        self.time_spent_waiting = 0
        Keg.speed = speed
        self.speed = speed
        self.rect = self.image.get_rect()
    ...
    def set_direction(self, direction):
        #set the image based on the direction
        if direction == "right":
            self.image = Keg.right
        elif direction == "downright":
            self.image = Keg.downright
        elif direction == "down":
            self.image = Keg.down
        elif direction == "downleft":
            self.image = Keg.downleft
        elif direction == "left":
            self.image = Keg.left
        elif direction == "upleft":
            self.image = Keg.upleft
        elif direction == "up":
            self.image = Keg.up
        elif direction == "upright":
